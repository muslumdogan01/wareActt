...
export const metadata = {
  title: "Terms & Conditions | WareAct",
  description: "Read the terms and conditions for using WareAct services.",
};
  ...
  return (
    <div className="bg-white">
      <div className="max-w-4xl mx-auto px-6 py-12 text-gray-700">
        <h1 className="text-3xl font-bold mb-8 text-blue-600">Terms & Conditions</h1>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">1. Use of Our Services</h2>
          <p>You must be at least 18 years old. You agree to use WareAct lawfully and in line with these Terms.</p>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">2. Account Registration</h2>
          <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">3. Subscription and Payment</h2>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">4. Intellectual Property</h2>
          <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">5. User Data</h2>
          <p>
            You own your data. We process it to provide services. Check our{" "}
            <a href="/legal/privacy-policy" className="underline text-blue-600">
              Privacy Policy
            </a>{" "}
            for more.
          </p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">6. Service Availability</h2>
          <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">7. Limitation of Liability</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">8. Termination</h2>
          <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">9. Changes to These Terms</h2>
          <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">10. Governing Law</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-4 text-blue-500">11. Contact Us</h2>
          <p>
