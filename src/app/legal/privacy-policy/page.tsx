...
export const metadata = {
  title: "Privacy Policy | WareAct",
  description: "Learn how WareAct protects your personal data.",
};
  ...
  return (
    <div className="bg-white">
      <div className="max-w-4xl mx-auto px-6 py-12 text-gray-700">
        <h1 className="text-3xl font-bold mb-8 text-blue-600">Privacy Policy</h1>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">1. Information We Collect</h2>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">2. How We Use Your Information</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">3. How We Share Your Information</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">4. Data Security</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">5. Data Retention</h2>
          <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">6. Your Rights</h2>
          <p className="mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">7. Third-Party Links</h2>
          <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 text-blue-500">8. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-4 text-blue-500">9. Contact Us</h2>
