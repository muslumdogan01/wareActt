...
<div className="max-w-4xl mx-auto px-6 py-12 text-white">
      <h1 className="text-3xl font-bold mb-8 text-blue-400">Cookie Policy</h1>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-blue-300">1. What Are Cookies?</h2>
        <p>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-blue-300">2. Types of Cookies We Use</h2>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-blue-300">3. How We Use Cookies</h2>
        <ul className="list-disc list-inside space-y-2">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-blue-300">4. Third-Party Cookies</h2>
        <p>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-blue-300">5. Managing Cookies</h2>
        <p className="mb-2">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4 text-blue-300">6. Changes to This Policy</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-4 text-blue-300">7. Contact Us</h2>
        <p>
          For any cookie-related questions, contact:<br />
