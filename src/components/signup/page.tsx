...
export default function SignupCard() {
  ...
  return (
    <div className="flex items-center justify-center px-4  lg:mb-60">
      <div className="w-[361px] h-[370px] lg:w-[1224px] lg:h-[235px] mb-[100px] lg:mb-0 2xl:h-[255px] rounded-[30px] bg-blue-500 lg:bg-transparent lg:bg-[url('/icons/signup/bg.svg')]  lg:bg-no-repeat lg:bg-cover  flex flex-col">
